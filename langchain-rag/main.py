...
if __name__ == "__main__":
    ...
    # create a document chain using all the documents that we have
    ...
    # NOTE, now we are going to do the RAG manually
    ...
    # we populate the context after retireving from vector store
    # context is a chain to run
    rag_cahin = (
